...
export class SessionQueue {
  ...
  add(config, priority = 5) {
    ...
    // Sort by priority (descending? 1 is high or 10 is high? index.js sorted a-b which is ascending. Assuming lower number = higher priority? Or usually higher number = higher priority.
    // index.js had: this.queue.sort((a, b) => a.priority - b.priority);
    // If priority 1 is high, then low numbers first.
